  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const now = Date.now();
        if (shadowingCache[userIdStr] && (now - shadowingCache[userIdStr].timestamp < CACHE_DURATION)) {
          setVideos(shadowingCache[userIdStr].data);
          setLoading(false);
          return;
        }
        ...
        shadowingCache[userIdStr] = { data: processedVideos, timestamp: now };
